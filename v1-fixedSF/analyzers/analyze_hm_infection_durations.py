...
if __name__ == '__main__':
    ...
    am = AnalyzeManager('a7c53091-8db8-e911-a2c1-c4346bcb1555', analyzers=InfectionDurationsByAgeAnalyzer(reference_path= ref_data_path))
    am.analyze()
