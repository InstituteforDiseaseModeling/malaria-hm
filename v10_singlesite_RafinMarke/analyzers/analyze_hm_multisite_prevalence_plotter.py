...
class Summary_Prevalence_Analyzer(BaseAnalyzer):
    ...
    def finalize(self, all_data):
        ...
        results.to_csv(os.path.join('..', f'iter{self.iteration}', f'{exp_id}','full_analyzer_results.csv'))
...
if __name__ == '__main__':
    iteration = 2
    am = AnalyzeManager('98af4394-c143-ea11-a2c3-c4346bcb1551',analyzers=Summary_Prevalence_Analyzer(iteration = iteration))
    am.analyze()