...
if __name__ == '__main__':
    ...
    iteration = 0
    am = AnalyzeManager('3d1429d9-3e3d-ea11-a2c3-c4346bcb1551',analyzers=Summary_Prevalence_Analyzer(cut_age = cut_age, cut_density = cut_density, cut_season = cut_season,iteration = iteration))
    am.analyze()