...
class Summary_Prevalence_Analyzer(BaseAnalyzer):
    ...
    def finalize(self, all_data):
        ...
        results.to_csv(os.path.join('..', f'iter{self.iteration}', f'{exp_id}','plotting_analyzer_results.csv'))
...
if __name__ == '__main__':
    iteration = 0
    am = AnalyzeManager('37ba9749-8c3c-ea11-a2c3-c4346bcb1551',analyzers=Summary_Prevalence_Analyzer(iteration = iteration))
    am.analyze()