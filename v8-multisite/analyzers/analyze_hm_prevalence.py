...
class Summary_Prevalence_Analyzer(BaseAnalyzer):
    ...
    def finalize(self, all_data):
        ...
        results.to_csv(os.path.join('..', 'iter0', f'{exp_id}','plotting_analyzer_results.csv'))
...
if __name__ == '__main__':
    ...
    am = AnalyzeManager('527ff53a-1d33-ea11-a2c3-c4346bcb1551',analyzers=Summary_Prevalence_Analyzer())
    am.analyze()
